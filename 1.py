...
import json
import pyttsx3
from difflib import get_close_matches #help us to get close words
...
def search():  #code for sreach button
    ...
    if word in data:
        ...
        textarea.config(state=NORMAL)
        textarea.delete(1.0, END)
        for item in meaning:  #storing the meaning
...
root = Tk() #creating object
root.geometry('1000x626+100+50')#size of window
root.title('Talking Dictionary created by Bismah Killedar')
